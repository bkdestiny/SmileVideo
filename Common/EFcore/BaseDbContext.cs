...
namespace Common.EFcore
{
    public abstract class BaseDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //optionsBuilder.UseSqlServer("Server=DESKTOP-464J600;Integrated Security=True;Database=SmileVideoDev;TrustServerCertificate=True;Trusted_Connection=True;MultipleActiveResultSets=true");
        }
